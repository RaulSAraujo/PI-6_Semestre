...
export const Novacarteira: React.FC = () => {
  ...
  const [selectedAcao, setSelectedAcao] = useState<IDetalhelistedshares | null>(null);
  ...
  const validateForm = (): boolean => {
    ...
    } else if (isNaN(parseFloat(formData.share_price.replace(/[^\d.-]/g, '')))) {
    ...
    } else if (isNaN(parseFloat(formData.invested_amount.replace(/[^\d.-]/g, '')))) {
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12}>
                    <StyledTextField
                      ...
                      helperText={errors.invested_amount || "Calculado automaticamente com base no preço e quantidade"}
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                            <Calculate />
                  ...
                  {formData.share_price && formData.quantity_purchased && formData.invested_amount && (
                    <Grid item xs={12}>
                      <SummaryCard>
                        <Box display="flex" alignItems="center" justifyContent="space-between">
                          <Box>
                            ...
                            <Typography variant="body1" fontWeight="500">
                              {formData.quantity_purchased} ações a {formatCurrency(formData.share_price)} cada
                            </Typography>
                          </Box>
                          <Box textAlign="right">
                            <Typography variant="subtitle2" color="textSecondary">
